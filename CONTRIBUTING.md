...
https://metacpan.org/release/HTTP-Headers-ActionPack

If you use cpanminus, you can do it without downloading the tarball first:

    $ cpanm --reinstall --installdeps --with-recommends HTTP::Headers::ActionPack
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends HTTP::Headers::ActionPack
...
The code for this distribution is [hosted at GitHub](https://github.com/houseabsolute/http-headers-actionpack).
...
can submit an issue report [via the web](https://github.com/houseabsolute/http-headers-actionpack/issues)
).
