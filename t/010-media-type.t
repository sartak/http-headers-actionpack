...
{
    my $parsed_media_type = HTTP::Headers::ActionPack::MediaType->new_from_string('application/xml;charset=UTF-8');
    isa_ok($parsed_media_type, 'HTTP::Headers::ActionPack::MediaType');
    ...
    my $media_type = HTTP::Headers::ActionPack::MediaType->new('application/xml', => ( 'charset' => 'UTF-8' ));
